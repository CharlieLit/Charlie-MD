...
if wget -q https://github.com/CharlieLi/Charlie-MD/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/CharlieLi/Charlie-MD\ncd Charlie-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/Charlie-Li/Charlie-MD\ncd Charlie-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/CharlieLi/Charlie-MD.git
