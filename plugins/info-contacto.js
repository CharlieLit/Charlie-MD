...
correo = official[0][0] == String(contact[0]) ? 'chonlonemerson10@gamil.com' : official[1][0] == String(contact[0]) ? 'chonlonemerson10@gmail.com' : official[2][0] == String(contact[0]) ? 'chonlonemerson10@gmail.com' : mail === '' ? lenguajeGB.smsContacto6() : mail
...
enlace = official[0][0] == String(contact[0]) ? 'https://github.com/GataNina-Li' : official[1][0] == String(contact[0]) ? 'https://github.com/CharlieLit' : official[2][0] == String(contact[0]) ? 'https://github.com/CharlieLit' : official[3][0] == String(contact[0]) ? 'https://github.com/CharlieLit' : md 
